...
if (!$helpRequest) {
    ...
    write-output "`t                     [-PatchesFilePath <string[]] [-AllNodes <bool> or <string[]> {'TRUE' or 'FALSE'}]"
    ...
    write-output "`t                     [-OutputFile <string[] (Note: '.csv' is automatically appended to specified file name.)]"
